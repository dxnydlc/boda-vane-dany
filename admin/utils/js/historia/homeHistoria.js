...
/* ------------------------------------------------------------- */
/* ------------------------------------------------------------- */
let urlServicio = `${URL_API}v1/historia/`;
/* ------------------------------------------------------------- */
/* ------------------------------------------------------------- */
    ...
    if (status === 200) {
        ...
        switch ( tipoReq ) {
            ...
            case 'guardar-cab':
                ...
                let Fecgha = moment( data.Fecha ).format('YYYY-MM-DD');
                $('#'+xIdForm+' #Fecha').val( Fecgha );
            ...
            case 'cargar-cab':
                ...
                let Fecgha2 = moment( data.Fecha ).format('YYYY-MM-DD');
                $('#'+xIdForm+' #Fecha').val( Fecgha2 );
...
function renderFormInTab( rowData , formId ) {
    ...
    <div class=" demo-card  rounded-xl mb-5 ">
        <div class=" demo-card-header d-flex align-items-center justify-content-between px-6 py-5  " >
            <h3 class="demo-card-title m-0">${ idCab == 0 ? 'Nuevo' : `Editar [${rowData.Titulo}] #${rowData.id}`}</h3>
        </div>
        ...
        switch ( field ) {
            ...
            case 'Fecha':
                ...
                <div class=" col-md-2 ">
                    ...
                    <input type="date" class="form-control" name="${field}" id="${field}" value="${rowData[field] ? rowData[field] : defaultValues[field]}" />
                </div>
                `;
            break;
            // -----------------------------------------
            case 'Historia':
                htmlForm += `
                <div class=" col-md-6 ">
                    <label for="inputBasicMessage" class="form-label">Historia:</label>
                    <textarea name="${field}" id="${field}" class="form-control" id="inputBasicMessage" rows="5">${rowData[field] ? rowData[field] : defaultValues[field]}</textarea>
                </div>
                `;
            break;
            // -----------------------------------------
