...
/* ------------------------------------------------------------- */
/* ------------------------------------------------------------- */
let urlServicio         = `${URL_API}v1/invitados/`;
/* ------------------------------------------------------------- */
/* ------------------------------------------------------------- */
...
/* ------------------------------------------------------------- */
/* ------------------------------------------------------------- */
const urlNovio          = `${URL_API}v1/novios/`;
/* ------------------------------------------------------------- */
/* ------------------------------------------------------------- */
/* ------------------------------------------------------------- */
/* ------------------------------------------------------------- */
let idCab = 0, uuidCab = ``, xIdClienteProv = 0, xIdSucursal = 0, idBoda = 0, idNovios = 0;
/* ------------------------------------------------------------- */
/* ------------------------------------------------------------- */
...
// campos hidden
const hiddenFields      = [ "id" , "uu_id" , "Foto" ];

// valores por defecto
const defaultValues = {
    id : 0 , max_companions : 0 , Foto : `img/512x512.png`
};
...
let eventFormulario, formDataGeneral, xIdForm = `0`;
...
(function($){
	$(document).ready(function()
    {
        ...
        /* ------------------------------------------------------------- */
        /* ------------------------------------------------------------- */
        $(`.comboBoda`).on( "change", function(e) {
            e.preventDefault();
            varDump( $(this).val() );
        });
        /* ------------------------------------------------------------- */
        ...
        $("#archivo").fileUploader({
            ...
            afterUpload: function(file, response) {
                ...
                $(`#${xIdForm} #Foto`).val( response.resized );
...
function prepararRequest( tipoReq ) {
    ...
    switch ( tipoReq ) {
        ...
        // -------------------------------------------------------------
        case 'get-novios':
            xUrl             = `${urlNovio}by-idboda/${idBoda}`;
            xMetodo          = `GET`;
        break;
        // -------------------------------------------------------------
        // -------------------------------------------------------------
    ...
    if (status === 200) {
        ...
        switch ( tipoReq ) {
            ...
            case 'get-novios':
                ...
                llenarCombo( arrNovio , `#${xIdForm} #IdNovio` , true );
                if( idNovios > 0 )
                    $(`#${xIdForm} #IdNovio`).val( idNovios );
            break;
            // -------------------------------------------------------------
            // -------------------------------------------------------------
            // -------------------------------------------------------------
        ...
        switch ( field ) {
            ...
            case 'Nombre':
                ...
                <div class="col-md-6 " >
                    ...
                    <input type="text" class="form-control" name="${field}" value="${rowData[field] || defaultValues[field] || ""}" placeholder="Jose/Maria" />
                </div>
                `;
            break;
            // -----------------------------------------
            case 'IdBoda':
                ...
                <div class="mb-5 col-md-3 ">
                    ...
                    <select id="${field}" name="${field}" class="form-select form-select-sm comboBoda "></select>
                </div>
                `;
            break;
            // -----------------------------------------
            case 'IdNovio':
                htmlForm += `
                <div class="mb-5 col-md-3 ">
                    <label for="IdNovio" class="form-label" >Novio/a:</label>
            ...
            case 'group_name':
                ...
                <div class=" col-md-3 ">
                    ...
                    <input type="text" class="form-control" name="${field}" value="${rowData[field] || defaultValues[field] || ""}" placeholder="Familia/Amigo/Testigo/Padrino" />
                </div>
                `;
            break;
            // -----------------------------------------
            ...
            case 'max_companions':
                ...
                <div class=" col-md-2 ">
                    ...
                    <input type="number" class="form-control" name="${field}" value="${rowData[field] ? rowData[field] : defaultValues[field] }"  />
                </div>
                `;
            break;
            // -----------------------------------------
            ...
            case 'Foto':
                htmlForm += `
                <div class="mb-5 col-md-2 ">
                    <img id="laFoto" src="${URL_API}img/512x512.png" class="img-thumbnail" alt="..." />
